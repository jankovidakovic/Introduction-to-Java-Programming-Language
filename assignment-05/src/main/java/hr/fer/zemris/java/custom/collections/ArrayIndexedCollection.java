...
public class ArrayIndexedCollection<E> implements List<E> {
	...
	E[] elements;		//array of object references
	...
	public ArrayIndexedCollection() {
		...
		elements = (E[]) new Object[capacity];	//allocation of memory
	...
	public ArrayIndexedCollection(int initialCapacity) {
		if (initialCapacity < 1) { 		//capacity can't be smaller than 1
			...
			elements = (E[]) new Object[initialCapacity];	//memory allocation
	 ...
	 */
	public ArrayIndexedCollection(Collection<? extends E> otherCollection) {
	 ...
	 * Successfully removal of element counts as a modification, and disables
	 ...
	 * <code>false</code>.
	 *
	 * @param value object which the collection is being searched for. Valid
	...
	@SuppressWarnings("unchecked")
	public E[] toArray() {
		E[] newArray = (E[])new Object[size];	//allocate the new array
	...
	private void resize(int targetCapacity) {
		...
		E[] temporaryArray = (E[])new Object[targetCapacity]; //new memory
	...
	private class ArrayElementsGetter implements ElementsGetter<E> {
		 ...
		 * deleted).
		 * @return next retrieved element of the collection.
		 * 
		 */
		@Override
