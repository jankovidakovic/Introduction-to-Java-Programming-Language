...
public interface List extends Collection {
	...
	/**
	 * Retrieves the elemnet of the collection at the given index.
	...
	/**
	 * Determines the index of the first occurence of the given element
	 ...
	 * 	non-negative integers smaller than the size of the list.
	 * @return index of the first occurence, or <code>-1</code> if collection
