 ...
 * ArrayIndexedCollection, which is implemented as a dynamic random acces
 * container.
...
public class ObjectStack {
	...
	//private variables
	private ArrayIndexedCollection elements; //inner container
	 ...
	 */
	public Object pop() {
		Object topElement = peek();	//throws NullPointerException for empty stack
	...
	public Object peek() {
		...
		Object topElement = elements.get(elements.size() - 1);
		return topElement;
