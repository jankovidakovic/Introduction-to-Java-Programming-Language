 ...
 * are generatable, SmartScriptLexer has different states which can generate
...
public class SmartScriptToken {
	...
	//private variables
	private SmartScriptTokenType type; //type of the token
	private Object value;	//value that the token stores
